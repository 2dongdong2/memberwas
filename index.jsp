            ...
            <div class="nav">
                <ul>
         	    ...
         	    session.setAttribute("userId", userId);
                    ...
                    %>
                            <li><a href="http://www.yjasu.shop?userId=<%= userId %>&sessionId=<%= compareSessionId %>">메인 페이지</a></li>
                            ...
                            <li>
                                ...
                                <a href="http://www.yjasu.shop/login/logout.jsp" style="color: black;">Logout</a>
                            </li>
                    <%
                        } else {
                    %>
