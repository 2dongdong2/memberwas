...
<body>
    <div class="wrap">
        ...
        <div class="banner">
            <button onclick="location.href='http://www.yjasu.shop/mileage_products'">마일리지 상품</button>
            <div class="session-info">
                ...
                %>
                    ...
                    <a href="http://www.yjasu.shop/login/logout.jsp" style="color: #009688;">Logout</a>
                <% } else { %>
        ...
        <div class="nav">
            <ul>
                <% 
                    if (userId != null) { 
                %>
                    <li><a href="http://www.yjasu.shop?userId=<%= userId %>&sessionId=<%= session.getId() %>">메인 페이지</a></li>
                ...
                %>
                    <li><a href="http://www.yjasu.shop/">메인 페이지</a></li>
